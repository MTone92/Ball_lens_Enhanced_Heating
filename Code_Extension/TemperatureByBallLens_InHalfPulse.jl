...
Ref = 0.06                      # Reflectance of the droplet (Ag20:0.06, Ge10:0.35,  Si05:0.28, Ge05:0.42, SDS:0.48)
γ = 10000                       # Absorption coefficient of the droplet (Ag20:10000, Ge10:770, Si05:625, Ge05:417, SDS:20)
n1 = 1.377                      # Refractive index of the droplet (Ag:1.377, Ge10:1.358, Si05:1.3478, Ge05:1.34, SDS: 1.33)

# Define the laser parameters:
R_laser = 0.26*10^(-3)       # Radius of the laser spot
...
l = BFL                             # Define the distance between the drop bottom and substrate
...
T = @distributed (+) for η_ind = 1:M
    ...
    for β_ind = 1:N
        ...
        Sn = Sn .+ Σn[:,:,β_ind]*(t/λ - (1-exp(-λ*t))/λ^2)
